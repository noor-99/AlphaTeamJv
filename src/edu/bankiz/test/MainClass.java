...
//        ***************************** Afficher noms des propriétaires des comptes *******************************
//        System.out.println(comptCont.afficherNomClientComptes());
...
//            System.out.println("Cette transaction n'existe pas !");
//        } else {
//            float montant = modifie.getMontant_transaction();
//            modifie.setType_transaction("Encaissement");
//            modifie.setMontant_transaction(100);
//            transCont.modifierTransaction(modifie, idtransmod);
//            Transaction t = transCont.rechercherTransaction(idtransmod);
//            float nouveau = t.getMontant_transaction();
//            float diff = nouveau - montant;
//            comptCont.modificationTransaction(t.getRIB_emetteur(), t.getRIB_recepteur(), diff);
//        }

        CompteController compt = new CompteController();
        System.out.println(compt.nbrComptes());
        System.out.println(compt.nbrComptesEpargne());
        System.out.println(compt.nbrComptesCourant());
    }
}
