...
public class Reclamation {
    ...
    public Reclamation(int nom_u_id, String type_rec, String date_rec, String etat_rec, String desc_rec) {
    ...
    public Reclamation(int id, int nom_u_id, String type_rec, String date_rec, String etat_rec, String desc_rec) {
        this.id = id;
        this.nom_u_id = nom_u_id;
        this.type_rec = type_rec;
        this.date_rec = date_rec;
